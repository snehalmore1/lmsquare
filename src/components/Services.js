            ...
            <section>
                <div className="m-auto max-w-6xl p-2 md:p-12 h-5/6">
                    ...
                    <div className="lg:w-1/2 flex flex-col lg:mx-4 justify-center">
                            ...
                            font-bold">We <span className='font-black'>Learn</span></h3>
                            <div>
                                <p className='my-3 text-xl text-gray-600 font-semibold'>
                                    Our Team is always keep updated with the latest technologies, process, trend in the market. This help us to understand and provide the robust solutions to any kind of problems of our customers. We believe on experiment thourgh learn as its never ending process.
                                </p>
                            </div>
                        </div>
                        <div className="lg:w-1/2 flex flex-col lg:mx-4 justify-center">
                            ...
                            <h3 className="text-3xl  text-blue-900 
                            font-bold">We <span className='font-black'>Make</span></h3>
                            <div>
                                <p className='my-3 text-xl text-gray-600 font-semibold'>
                                    With over many years experience in software analysis and design and a deep understanding of the latest IT trends and solutions, we provide customized recommendations and strategies to help you improve your operations, reduce costs, and increase efficiency.
                                </p>
                            </div>
                        </div>
                        <div className="lg:w-1/2 flex flex-col lg:mx-4 justify-center">
                            ...
                            <h3 className="text-3xl  text-blue-900 
                            font-bold">We <span className='font-black'>Modify</span></h3>
                            <div>
                                <p className='my-3 text-xl text-gray-600 font-semibold'>
                                    With over many years experience in software analysis and design and a deep understanding of the latest IT trends and solutions, we provide customized recommendations and strategies to help you improve your operations, reduce costs, and increase efficiency.
                                </p>
